                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php $Category = DB::table('categories')->where('id',$item->category_id)->get(); ?>
                                @foreach ($Category as $cat)
                                <a target="new" href="{{url('/')}}/admin/editCategories/{{$cat->id}}"> {{$cat->title}} </a>
                                @endforeach
                            </td>
                            <td>
                                <a target="new" href="{{url('/')}}/product/{{$item->slung}}"><img width="150" src="{{url('/')}}/uploads/products/{{$item->image}}"></a>
                            </td>
